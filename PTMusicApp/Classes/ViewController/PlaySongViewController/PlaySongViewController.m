...
-(void) fixMultiScreenSize{
    ...
    self.pageView.frame=CGRectMake(self.pageView.frame.origin.x, self.pageView.frame.origin.y, SCREEN_WIDTH_PORTRAIT, screen_height-self.pageView.frame.origin.y-footerHeightView + 30);
    
    
    self.footerView.frame = CGRectMake(0,screen_height-footerHeightView, SCREEN_WIDTH_PORTRAIT, footerHeightView); // the player always is bottom
