...
//#define BASE_URL_MENDY_USER         @"http://myjli.com/crm/api/users/"
#define BASE_URL_MENDY_USER         @"http://myjli.com/crm/index.php/api/users/"

#define BASE_URL_MENDY_DASHBOARD @"http://myjli.com/mobile-dashboard/"
#define BASE_URL_MEDY     @"http://myjli.com/mp3online/index.php/api/"
#define BASE_URL_MEDY_ADS       @"http://myjli.com/api/"
#define BASE_URL_MEDY_FEEDBACK       @"http://myjli.com/mp3online/feedback/"
